      ...
      <div class="column is-4">
        ...
        <div class="field">
          ...
          <template v-if="$v.username.$error">
            ...
            <p
              ...
              v-if="!$v.username.minLength && $v.username.required"
            >
              too short
            </p>
            <p
        ...
        <div class="field">
          ...
          <template v-if="$v.password.$error">
            ...
            <p
              class="help is-danger"
              v-if="!$v.password.password && $v.password.required && $v.password.minLength"
            >
              too easy
            </p>
        ...
        <div class="field">
          ...
          <template v-if="$v.confirm_password.$error">
            ...
            <p
              class="help is-danger"
              v-if="
                !$v.confirm_password.confirm_password &&
        ...
        <div class="field">
          ...
          <template v-if="$v.mobile.$error">
            ...
            <p class="help is-danger" v-if="!$v.mobile.mobile && $v.mobile.required">
        ...
        <div class="field">
          ...
          <template v-if="$v.first_name.$error">
            ...
            <p
              class="help is-danger"
              v-if="!$v.first_name.maxLength && $v.first_name.required"
            >
              too long
            </p>
          </template>
        ...
        <div class="field">
          ...
          <template v-if="$v.last_name.$error">
            ...
            <p
              class="help is-danger"
              v-if="!$v.last_name.maxLength && $v.last_name.required"
            >
              too long
            </p>
          </template>
